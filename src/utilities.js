...
export function stringToColorAndOpacity(linkColumn, highlightedLinkColumn, selectedLink) {
    ...
    let matchColor = (whichLinkToConsider.downstream + 1) * (whichLinkToConsider.upstream + 1);
